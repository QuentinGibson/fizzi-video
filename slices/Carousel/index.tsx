...
function ArrowButton({ direction, label, onClick }: ArrowButtonProps) {
  return (
    <button
      ...
      className="text-2xl font-bold z-20 size-12 rounded-full border-2 border-white bg-white/10 p-3 opacity-85 ring-white focus:outline-none focus-visible:opacity-100 focus-visible:ring-4 md:size-16 lg:size-20"
    >
